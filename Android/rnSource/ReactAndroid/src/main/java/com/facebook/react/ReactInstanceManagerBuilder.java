...
public class ReactInstanceManagerBuilder {
  ...
  //CRN END ReactInstanceManagerBuilder() {
  //}
  /**
  ...
  public ReactInstanceManagerBuilder setJSBundleFile(String jsBundleFile) {
    return setJSBundleFile(jsBundleFile, false);
  }
   ...
   * Example: {@code "assets://index.android.js" or "/sdcard/main.jsbundle"}
   */
  public ReactInstanceManagerBuilder setJSBundleFile(String jsBundleFile, boolean sync) {
    if (jsBundleFile.startsWith("assets://")) {
      mJSBundleAssetUrl = jsBundleFile;
      mJSBundleLoader = null;
      return this;
    }
    return setJSBundleLoader(JSBundleLoader.createFileLoader(jsBundleFile, jsBundleFile, sync));
  }
  // CRN END
  ...
  //CRN BEGIN
  public ReactInstanceManagerBuilder setBundleScript(String script, String sourceUrl) {
    return setBundleScript(script, sourceUrl, false);
  }

  public ReactInstanceManagerBuilder setBundleScript(String script, String sourceUrl, boolean sync) {
    if (!TextUtils.isEmpty(script)) {
      StringBuilder scriptAndUrl = new StringBuilder();
      scriptAndUrl.append("script://");
      if (sourceUrl != null) {
        scriptAndUrl.append("<url>");
        scriptAndUrl.append(sourceUrl);
        scriptAndUrl.append("</url>");
      }
      scriptAndUrl.append(script);
      return this.setJSBundleFile(scriptAndUrl.toString(), sync);
    } else {
      return this.setJSBundleFile(null, sync);
    }
  }
