...
//      mainModuleName, BundleType.BUNDLE, getHostForJSProxy());
    ...
    String hostInfo = getHostForJSProxy();
    if (hostInfo.equals(AndroidInfoHelpers.DEVICE_LOCALHOST)) {
      hostInfo = mSettings.getPackagerConnectionSettings().getDebugServerHost();
    }
    ...
    // host itself.
    return createBundleURL(mainModuleName, BundleType.BUNDLE, hostInfo);
