...
- (void)updateModuleIdConfig:(NSDictionary *)moduleIdConfig {
  if (self.moduleIdConfig == NULL && moduleIdConfig!= NULL) {
    self.moduleIdConfig = moduleIdConfig;
    
    __block std::unordered_map<std::string, std::string> xbundleConfig;
    [self.moduleIdConfig enumerateKeysAndObjectsUsingBlock:^(NSString*  _Nonnull key,
